...
██   ██ ██   ██ ██ ██   ██ ██   ██    ██    
██   ██ ██   ██ ██ ██████  ██   ██    ██    
        ︻デ═一 CREATE BY : HRIDAY CHAUDHARY 
\x1b[1;94m────────────────────────────────────────────────────
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] Author   : ehriday
\x1b[1;97m [\x1b[1;92m•\x1b[1;94m•\x1b[1;97m] Github   : https://github.com/hridaychaudhary
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] Facebook : https://facebook.com/ctrl.ehriday
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] YouTub   : ehriday
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] whatsapp : +9779863094074
\x1b[1;94m────────────────────────────────────────────────────""")

def yayanxd():
    yayan = input("\n\033[00m\t   [\033[96m Press Enter To Return\033[97m ] ")
    if yayan == "":
        os.system("python hriday.py")
    else:
...
def moch_yayan():
    time.sleep(0.1)
    print("\033[97m [\033[96m01\033[97m] Start Clone ID Public")
    ...
    if yayan == "1" or yayan == "01":
        ...
        def masuk():
            ...
            if "mbasic_logout_button" in str(ismi):
                if "Apa yang Anda pikirkan sekarang" in str(ismi):
                    ...
                    try:
                        requests.get(
                            mbasic.format(parser(ismi, "html.parser").find("a", string="Bahasa nepal")["href"]),
                            cookies=cek)
                    except:
                        pass4
        ...
        if __name__ == '__main__':
            try:
                ...
                jembut()
                print(
                    '\n\x1b[1;92m        ∆∆∆_______HRIDAY CHAUDHARY 𝙸𝚖 𝚗𝚘𝚝 𝚋𝚊𝚍 𝚒𝚖 𝚢𝚘𝚞 𝚊𝚛𝚎 𝚍𝚊𝚍 . _______∆∆∆')
                print('\x1b[1;97m     疊╔═╦═────••♽••─────═╦═╗疊')
        ...
        os.system('xdg-open https://github.com/hridaychaudhary')
        yayanxd()
